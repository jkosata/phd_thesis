...
%In Sec.~\ref{sec:spins_scheme}, we provide an accessible explanation of the proposed sensing scheme, followed by a full model description in Sec.~\ref{sec:spins_model}. In Sec.~\ref{sec:spins_stochastic}, we add the effects of noise to calculate signal-to-noise ratios (SNR) -- the primary figure of merit for the potential application. Finally, we discuss the implications and directions for future work in Sec.~\ref{sec:spins_disc}.
